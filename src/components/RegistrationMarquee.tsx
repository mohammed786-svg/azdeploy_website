...
export default function RegistrationMarquee() {
  const text = " /// UPDATES: REGISTRATION OPEN ! | STAGE SET | SECURE YOUR SPOT | PYTHON_FULL_STACK | ANDROID_DEV | LIMITED SEATS — 25 PER BATCH | FIRST 10 GET 30% OFF | CONTACT: +91 82965 65587 | ENROLL NOW ";
