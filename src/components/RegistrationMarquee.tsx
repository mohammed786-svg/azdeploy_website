...
export default function RegistrationMarquee() {
  const text = " /// ONE_ONGOING_PROGRAM · FULL-STACK + AI + DEVOPS · BELAGAVI · BATCHES: 9AM-11AM | 3PM-5PM | 6PM-8PM · CHOOSE_YOUR_FOCUS · FIRST 10: 30% OFF · TOP PERFORMER: MACBOOK PRO · +91 82965 65587 · +91 73383 60607 · WWW.AZDEPLOY.COM ";
